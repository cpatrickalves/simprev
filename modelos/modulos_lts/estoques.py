...
Módulo de estimativa de Estoques do modelo LTS
 - Versão com correções na estimativa de beneficiários
 - Os beneficiários são estimados a partir dos contribuintes e não da população ocupada
